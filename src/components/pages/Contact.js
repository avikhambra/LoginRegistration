...
const Contact = () => {
  return <>
    <Grid container justifyContent='center'>
      <Grid item sm={10}>
        <h1 style={{display:"flex",justifyContent:"center" ,alignItems:"center"}}  >Contact Page</h1>
        <hr />
        ...
        <div>
          <img src={Image} alt="" style={{display:"flex",justifyContent:"center",alignItems:"center" , width:"850px" , height:"510px"  , marginLeft: '18.5vw'}} />
        </div>
